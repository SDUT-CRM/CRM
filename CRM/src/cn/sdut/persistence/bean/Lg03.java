...
public class Lg03 implements java.io.Serializable {
	...
	public Date getLg0308() {
		return this.lg0308;
	}

	public void setLg0308(Date lg0308) {
		this.lg0308 = lg0308;
	}

	public Date getLg0309() {
		return this.lg0309;
	}

	public void setLg0309(Date lg0309) {
		this.lg0309 = lg0309;
	}
